...
ggplot() +
  geom_sf(data = pakistan_district_shape, fill = "lightgray") +  # Plot all districts of Pakistan
  geom_sf(data = punjab, fill = "skyblue") +  # Highlight Punjab province with red color
  labs(title = "Map of Pakistan with Highlighted Punjab Province (Sampled Province)") +
  theme_minimal()
```
...
ggplot(data = pakistan_district_shape, aes(geometry = geometry)) +
  geom_sf(data = punjab, fill = NA, color = "black") +
...
```{r}
new_pakistan_shape <- st_read("/Users/hannahreynolds/Desktop/GitHub/finalproject/pakistan_districts/pakistan_districts.shp")
