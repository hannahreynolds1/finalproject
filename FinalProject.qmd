...
school_gps <-read_excel("/Users/ritwika.rituparna/Documents/Georgetown/Spring 2024/Intro to Data Science/finalproject/Data/GPS_List.xlsx")
```
...
**Maps 3-5** capture the spread of the sampled schools in the three sample districts of Attock, Faisalabad, and Rahim Yar Khan in the Punjab province.
...
ggplot() +
  ...
  geom_point(data = attock_schools, aes(x = Longitude, y = Latitude), color = "red") +
...
ggplot() +
  ...
  geom_point(data = fsd_schools, aes(x = Longitude, y = Latitude), color = "red") +
...
ggplot() +
  ...
  geom_point(data = ryk_schools, aes(x = Longitude, y = Latitude), color = "red") +
